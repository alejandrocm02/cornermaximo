...
export default function FavoritesPage() {
  return <div className="space-y-8">
    <Breadcrumbs items={[{ label: 'Mi Corner', href: '/mi-corner' }, { label: 'Favoritos' }]} />
